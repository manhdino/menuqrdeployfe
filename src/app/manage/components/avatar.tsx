    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <span className="block mr-1 font-medium text-theme-sm">{account?.name}</span>
        </button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align='end' className='w-[260px]'>
        <DropdownMenuItem className='flex-col items-start'>
          <span className='text-base font-semibold'>{account?.name}</span>
          <span className='text-[13px] text-[#667085]'>{account?.email}</span>
        </DropdownMenuItem>
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem onClick={logout} className='flex gap-3 items-center text-[15px]'>
          <svg
