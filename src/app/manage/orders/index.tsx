...
import AddOrder from '@/app/manage/orders/add'
import EditOrder from '@/app/manage/orders/edit'
import { createContext, useEffect, useMemo, useState } from 'react'
import { useSearchParams } from 'next/navigation'
import AutoPagination from '@/components/common/auto-pagination'
import { getVietnameseOrderStatus, handleErrorApi } from '@/lib/utils'
import { OrderStatusValues } from '@/constants/type'
import OrderStatics from '@/app/manage/orders/components/order-statics'
import orderTableColumns from '@/app/manage/orders/components/order-table-columns'
import { useOrderService } from '@/app/manage/orders/components/order.service'
...
import TableSkeleton from '@/app/manage/orders/components/table-skeleton'
import toast from 'react-hot-toast';
import { GuestCreateOrdersResType } from '@/validations/guest.schema'
import {
...
export default function OrderTable() {
  ...
  useEffect(() => {
    ...
    function onUpdateOrder(data: UpdateOrderResType['data']) {
      ...
      // toast.success(`Món ${name} (SL: ${quantity}) ${getVietnameseOrderStatus(data.status)}`)
      refetch()
    }
